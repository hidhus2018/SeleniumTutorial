...
public class POMTime {
	...
	public static void Reports(WebDriver driver) {
		...
		WebElement AttendanceSmry = driver
				.findElement(By.xpath("//a[@ id='menu_time_displayAttendanceSummaryReportCriteria']"));
		...
		// WebElement DateFrom = driver.findElement(By.xpath("//input
		// [@id='from_date']"));
		// Actions action11 = new Actions(driver);
		// action11.moveToElement(DateFrom).doubleClick().build().perform();
		//
		// WebElement MonthName = driver.findElement(By.xpath("//select
